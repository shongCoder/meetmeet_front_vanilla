export function HeaderBlack() {
  let isOpen = false;
  let token = localStorage.getItem("token"); // 로컬스토리지에서 토큰 확인

  const html = `
    <div id="header-black" class="lg:h-20 fixed top-0 left-0 w-full z-50 h-[3.5rem] bg-white opacity-95 fade-in">
