export function Footer() {
    ...
    setTimeout(() => {
      const toggleBtn = footerElement.querySelector("#toggleBtn");
      const toggleIcon = footerElement.querySelector("#toggleIcon");
      const toggleBox = footerElement.querySelector("#toggleBox");
      ...
      toggleBtn.addEventListener("click", () => {
        ...
        toggleBox.classList.toggle("max-h-[1000px]", isOpen);
        toggleBox.classList.toggle("max-h-0", !isOpen);
      });
    }, 0);
  
    return footerElement; // ✅ DOM 자체 반환
} 