...
`;document.querySelector("#contents").appendChild(l());const m=document.querySelector("#exchange-btn"),t=document.querySelector("#no-record"),s=document.querySelector("#record-list");let e=!1;m.addEventListener("click",()=>{e=!e,e?(t.classList.add("hidden"),s.classList.remove("hidden")):(t.classList.remove("hidden"),s.classList.add("hidden"))});
